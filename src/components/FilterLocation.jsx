...
const FilterLocation = () => {
  ...
  return (
    ...
    {/* Dropdown toggle button */}
      ...
      <div onClick={toggleDropdown} className=" z-10 p-2 text-gray-700 bg-white border border-gray-300 rounded-lg dark:text-white focus:border-blue-500 focus:ring-opacity-40 focus:ring-blue-300  focus:ring  focus:outline-none">
